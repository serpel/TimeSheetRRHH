...
namespace RRHH.Controllers
{
    public class ShiftsController : Controller
    {
        ...
        {
            var shifts = db.Shifts.Include(s => s.Company);
        ...
        public ActionResult Create([Bind(Include = "ShiftId,CompanyId,Name,Description,IsSpecialShift,InsertedAt,UpdatedAt,IsActive")] Shift shift)
        {
